...
class AbstractDataLoader(object):
    ...
    Attributes:
        ...
        real_time (bool): If ``True``, dataloader will do data pre-processing, such as neg-sampling and data-augmentation.
    ...
    def data_preprocess(self):
        """ This function is used to do some data preprocess, such as pre-neg-sampling and pre-data-augmentation. By default, it will do nothing. """
        pass
...
class TrainDataLoader(AbstractDataLoader):
    ...
    def __init__(self, config, dataset, batch_size=1, shuffle=False):
        ...
        if config['use_neg_sampling']:  # True
    ...
    def pretrain_setup(self):
        """ Reset dataloader. Outputing the same positive & negative samples with each training. :return: """
        # sort & random
        if self.shuffle:

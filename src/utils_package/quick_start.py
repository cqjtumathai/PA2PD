...
def quick_start(model, dataset, config_dict, item_num, save_model=True):
    # merge config dict
    ...
    logger.info('Start {}-th training!!'.format(item_num))
    # logger.info(config)
    ...
    # hyper_tuple = ['reg_weight', 'learning_rate', 'dropout', 'mask_weight_f', 'mask_weight_g', 'align_weight', 'temp', 'seed']
    # combinators = [(0.001, 0.0001, 0.5, 1.5, 0.1, 0.1, 0.2, 999)]
